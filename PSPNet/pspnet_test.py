...
def test(model, dataloader, device, output_dir="pspnet_outputs"):
    model.eval()
    iou_list = []
...
def main():
    ...
    model_path = "pspnet_idd.pth"  # Path to trained model weights
    batch_size = 8
    ...
    print(f"Saved {len(test_dataset)} predicted masks in pspnet_outputs")
